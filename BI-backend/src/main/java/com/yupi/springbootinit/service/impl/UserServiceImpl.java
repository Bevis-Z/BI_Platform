...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        if (!userPassword.equals(checkPassword)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "Password not matched");
        }
        synchronized (userAccount.intern()) {
            ...
            if (count > 0) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "Account Repeat");
            }
            // 2. 加密
            ...
            if (!saveResult) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "Register Fail, Database Incorrect");
            }
            return user.getId();
        }
    }
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        if (userAccount.length() < 4) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "Incorrect UserAccount");
        }
